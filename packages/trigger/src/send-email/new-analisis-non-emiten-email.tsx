...
import Email from '@repo/email/templates/new-analisis-non-emiten'
...
export const newAnalisisNonEmitenEmail = trigger.defineJob({
  id: 'new-analisis-non-emiten-email',
  name: 'New Analisis Non Emiten Email',
  version: '0.1.0',
  ...
  run: async (payload, io, _ctx) => {
    ...
    for (const user of allUsers) {
      ...
      await io.runTask(
        `send-analisis-non-emiten-email-${user.id}`,
        async () => {
