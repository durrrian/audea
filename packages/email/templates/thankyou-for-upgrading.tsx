...
function Email({
  ...
  const title = `Upgrade membership berhasil!`

  const previewText = `Terima kasih atas kepercayaan mu terhadap Supercuan Saham`
      ...
      <Tailwind>
        <Body>
          <ContainerBody>
            ...
            <Text>
              Terimakasih sudah upgrade tipe membership dan percaya dengan Supercuan Saham. Membership kamu sudah
              otomatis diperbarui.
            </Text>
