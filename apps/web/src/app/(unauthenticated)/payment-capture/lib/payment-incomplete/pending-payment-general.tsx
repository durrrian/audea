...
export function PendingPaymentGeneral({ cancelUrl }: Props) {
  return (
    <main className='mt-10 mb-20 md:px-2 px-4 overflow-x-hidden'>
      <Card className={cn('w-fit h-fit mx-auto max-w-[500px]')}>
        ...
        <CardContent className='space-y-6 text-justify'>
          <p>
            Tolong selesaikan transaksi kamu dengan mengotorisasi pembayaran melalui bank pilihan kamu. Dengan
            mengotorisasi dan menyelesaikan transaksi ini, kamu akan dapat menyelesaikan pembelian membership Supercuan
            Saham kamu.
          </p>
