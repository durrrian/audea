import { ALVIN_EMAIL, ALVIN_EMAIL_LINK, WHATSAPP_NUMBER, WHATSAPP_LINK } from '@repo/helper'

<title>Supercuan Saham — Privacy Policy</title>

<main className='max-w-[1100px] mx-auto mt-20 mb-40 space-y-4 px-2'>
...
By email: <a className='underline' href={ALVIN_EMAIL_LINK}>{ALVIN_EMAIL}</a>

By WhatsApp: {WHATSAPP_NUMBER} or <a className='underline' href={WHATSAPP_LINK}>click here</a>
